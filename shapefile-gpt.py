...
def extract_street_network_data(place_name="Hampstead, Montreal, Canada",
                                buffer_sizes=(200, 5),
                                point_sampling_distance=1,
                                allowed_highways=["residential", "tertiary", "secondary", "primary", "unclassified"],
                                crs_codes=("EPSG:4326", "EPSG:32188"),
                                output_filename="sampled_points.csv"):
    source_crs, target_crs = crs_codes
    ...
    for idx, row in streets_proj.iterrows():
        ...
        points_proj = points_proj.append(points_gdf, ignore_index=True)
